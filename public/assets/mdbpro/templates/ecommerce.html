  ...
  <main>
    ...
    <div class="container">
      ...
      <section class="section pb-3 wow fadeIn" data-wow-delay="0.3s">
        ...
        <!--Section heading-->
        <h1 class="section-heading h1 pt-4">Last products</h1>
        <!--Section description-->
        <p class="section-description mb-5 pb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fugit, error amet numquam iure provident voluptate esse
          quasi, veritatis totam voluptas nostrum quisquam eum porro a pariatur accusamus veniam.</p>
    ...
    <div class="container">
      ...
      <section class="text-center pb-5 wow fadeIn">
        ...
        <!--Section description-->
        <p class="px-5 mb-5 pb-3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur
